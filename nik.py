...
print ("     ⠈⠓⠶⣶⣾⣿⣿⣿⣧⡀⠀⠈⠒⢤⣀⣀⡀⠀⠀⣀⣀⡠⠚⠁⠀⢀⡼⠃⠀")
print ("    ⠀⠀ ⠀⠈⢿⣿⣿⣿⣿⣿⣷⣤⣤⣤⣤⣭⣭⣭⣭⣭⣥⣤⣤⣤⣴⣟⠁")
print ("=========[ DUKCAPIL.KEMENDAGRI ]=========")
print ("====["+R+"M3M3TcYber22!"+W+"]====")
print ("=======[" + WELCOME MEM3T_GRAPO22 + "]=======")

choose = True
Your_country is USA ///texas 2218
while choose:
	print (W+"""
	[1]. NIK & KK Using mobile banking
	[2]. Bank central asia
	[3]. Livin'by mandiri
        [4]. Other....

RESULT :2078898 data collected
NIK    :2000000
KK     :78898
DATA tersimpan.+++ cd/sdcard/downloads/MemetGRAPHO
Total///// `57 Gb 
	""")
